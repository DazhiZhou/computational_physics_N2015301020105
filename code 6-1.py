...
w=0.1*2*const.pi #the angular velocity
theta=20
...
z[0]=1.5
i=0#will be used in circle
w=0.3*2*const.pi #the angular velocity
theta=20
theta=(theta*const.pi)/180 #the intial angular orientation
ay=5*(sin(4*theta)-0.25*sin(8*theta)+0.08*sin(12*theta)-0.025*sin(16*theta))
az=-10
...
z[0]=1.5
i=0#will be used in circle
w=0.4*2*const.pi #the angular velocity
theta=20
theta=(theta*const.pi)/180 #the intial angular orientation
ay=5*(sin(4*theta)-0.25*sin(8*theta)+0.08*sin(12*theta)-0.025*sin(16*theta))
az=-10
...
first_legend=pl.legend([plot1,plot2,plot3,plot4],['w1','w2','w3','w4'])
pl.show  
